...
image.image2file(image.gray2color(vec2listlist(centroid1)), "/tmp/temp2.png")
image.image2file(image.gray2color(vec2listlist(centroid1)), "/tmp/temp3.png")
image.image2file(image.gray2color(vec2listlist(centroid1)), "/tmp/temp4.png")
image.image2file(image.gray2color(vec2listlist(centroid1)), "/tmp/temp5.png")
image.image2file(image.gray2color(vec2listlist(centroid1)), "/tmp/temp6.png")
image.image2file(image.gray2color(vec2listlist(centroid1)), "/tmp/temp7.png")
image.image2file(image.gray2color(vec2listlist(centroid1)), "/tmp/temp8.png")
image.image2file(image.gray2color(vec2listlist(centroid1)), "/tmp/temp9.png")
image.image2file(image.gray2color(vec2listlist(centroid1)), "/tmp/temp10.png")
'''
